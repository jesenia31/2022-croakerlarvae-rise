...
```{r load csvs}
photos <- read_csv("tutorials/DataSheetPhotos_Practice.csv")

measurements <- read_csv("tutorials/Measurements_practice.csv")

icthy_data <- read_csv("tutorials/icthy_data_Practice.csv")
