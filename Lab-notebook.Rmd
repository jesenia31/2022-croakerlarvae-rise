...
#July 15
Continued working with the data analysis and data cleaning
Fixed the measurements of the fix in ObjectJ and then pulled out a new data frame
Started creating a script for the 5MP

#July 18
Understanding how to interpret and explain my graphs for the 5MP, created axis and title for the graphs

#July 18-21
Worked and focused on the 5MP, finishing slides and practicing what I was going to say on the Mini-Symposium

#July 22
Presented in the Mini Symposium my 5MP

#July 25
Submitted the abstract and autobiography to be published in the booklet

#July 26
Continued working on the poster, adding pictures and images

#July 27
Continued working on the poster, adding the results and methods, writing the text

#July 28
Finished editing the poster. 
Presented my poster at lab meeting and received feedback

#July 29
Made the final edits to the poster and submitted it to printing

#August1
Submitted the pdf version of the poster to the digital archives and recorded the video

#August 2
Went and picked up the poster at the Chemistry Department
