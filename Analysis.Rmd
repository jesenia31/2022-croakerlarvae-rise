...
ggplot(data=atlantic_croaker_final) +
  ...
  theme_bw() +
  theme(axis.text = element_text(size=12), panel.border = element_rect(size=4))

ggplot(data=atlantic_croaker_final) +
  geom_boxplot(aes(x=factor(Year), y=aspect_ratio, group=factor(Year)), size=0.5) + theme_bw() +
  theme(axis.text = element_text(size=12), panel.border = element_rect(size=4))
...
ggplot(data=atlantic_croaker_final) +
  geom_boxplot(aes(x=factor(Year), y=Totallength, group=factor(Year)), size=0.5) + theme_bw() +
  theme(axis.text = element_text(size=12), panel.border = element_rect(size=4))
...
ggplot(data=atlantic_croaker_final) +
  geom_boxplot(aes(x=factor(Year), y=square_caudal_peduncle_depth_factor, group=factor(Year)), size=0.5) + theme_bw() +
  theme(axis.text = element_text(size=12), panel.border = element_rect(size=4))
